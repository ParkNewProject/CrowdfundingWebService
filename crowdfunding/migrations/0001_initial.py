# Generated by Django 2.2.3 on 2019-09-02 06:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contrib_pid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='crowdfunding.CrfProject', verbose_name='고유번호')),
                ('contrib_user', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='기여자')),
            ],
        ),
    ]
